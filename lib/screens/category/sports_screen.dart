...
class _SportsScreenState extends State<SportsScreen> {
  ...
  Future<void> _loadSportsItems() async {
    setState(() {
      isLoading = true;
    });
    final items = await DBHelper.getUsedItemsByCategory('스포츠/레저');
    setState(() {
      sportsItems = items;
      isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : sportsItems.isEmpty
              ? const Center(
                  child: Text('아직 등록된 스포츠/레저 상품이 없습니다.',
