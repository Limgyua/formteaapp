...
class _BikeScreenState extends State<BikeScreen> {
  List<Map<String, dynamic>> bikeItems = [];
  bool isLoading = true;
  ...
  Future<void> _loadBikeItems() async {
    setState(() {
      isLoading = true;
    });
    final items = await DBHelper.getUsedItemsByCategory('자전거');
    setState(() {
      bikeItems = items;
      isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : bikeItems.isEmpty
              ? const Center(
                  child: Text('아직 등록된 자전거 상품이 없습니다.',
