...
class _ElectronicsScreenState extends State<ElectronicsScreen> {
  List<Map<String, dynamic>> electronicsItems = [];
  bool isLoading = true;

  @override
  void initState() {
    super.initState();
    _loadElectronicsItems();
  }

  Future<void> _loadElectronicsItems() async {
    setState(() {
      isLoading = true;
    });
    final items = await DBHelper.getUsedItemsByCategory('전자제품');
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : electronicsItems.isEmpty
              ? const Center(
                  child: Text('아직 등록된 전자제품이 없습니다.',
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, idx) {
                    final item = electronicsItems[idx];
                    // 가격 표시 포맷
                    String priceText = '';
